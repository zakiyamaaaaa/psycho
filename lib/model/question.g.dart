...
void _questionSerialize(
  ...
  writer.writeDateTime(offsets[0], object.answeredDate);
  ...
  writer.writeBool(offsets[6], object.isAnswered);
...
Question _questionDeserialize(
  ...
  object.isAnswered = reader.readBool(offsets[6]);
...
extension QuestionQueryFilter
  ...
  QueryBuilder<Question, Question, QAfterFilterCondition> imagePathEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Question, Question, QAfterFilterCondition> imagePathGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Question, Question, QAfterFilterCondition> imagePathLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Question, Question, QAfterFilterCondition> imagePathBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Question, Question, QAfterFilterCondition> imagePathStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Question, Question, QAfterFilterCondition> imagePathEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Question, Question, QAfterFilterCondition> imagePathContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Question, Question, QAfterFilterCondition> imagePathMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Question, Question, QAfterFilterCondition> imagePathIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'imagePath',
        value: '',
...
extension QuestionQuerySortBy on QueryBuilder<Question, Question, QSortBy> {
  QueryBuilder<Question, Question, QAfterSortBy> sortByAnsweredDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'answeredDate', Sort.asc);
    });
  }

  QueryBuilder<Question, Question, QAfterSortBy> sortByAnsweredDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'answeredDate', Sort.desc);
    });
  }
  ...
  QueryBuilder<Question, Question, QAfterSortBy> sortByImagePath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'imagePath', Sort.asc);
    });
  }

  QueryBuilder<Question, Question, QAfterSortBy> sortByImagePathDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension QuestionQuerySortThenBy
  ...
  QueryBuilder<Question, Question, QAfterSortBy> thenByAnsweredDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'answeredDate', Sort.asc);
    });
  }

  QueryBuilder<Question, Question, QAfterSortBy> thenByAnsweredDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'answeredDate', Sort.desc);
    });
  }
  ...
  QueryBuilder<Question, Question, QAfterSortBy> thenByImagePath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'imagePath', Sort.asc);
    });
  }

  QueryBuilder<Question, Question, QAfterSortBy> thenByImagePathDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'imagePath', Sort.desc);
    });
  }
...
extension QuestionQueryWhereDistinct
  ...
  QueryBuilder<Question, Question, QDistinct> distinctByAnsweredDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'answeredDate');
    });
  }
  ...
  QueryBuilder<Question, Question, QDistinct> distinctByImagePath(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension QuestionQueryProperty
  ...
  QueryBuilder<Question, String, QQueryOperations> imagePathProperty() {
    return QueryBuilder.apply(this, (query) {
